...
func newAlias(db *gorm.DB, opts ...gen.DOOption) alias {
	...
	_alias.aliasDo.UseModel(&model.Alias{})
...
type IAliasDo interface {
	...
	Unscoped() IAliasDo
	Create(values ...*model.Alias) error
	CreateInBatches(values []*model.Alias, batchSize int) error
	Save(values ...*model.Alias) error
	First() (*model.Alias, error)
	Take() (*model.Alias, error)
	Last() (*model.Alias, error)
	Find() ([]*model.Alias, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.Alias, err error)
	FindInBatches(result *[]*model.Alias, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.Alias) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.Alias, error)
	FirstOrCreate() (*model.Alias, error)
	FindByPage(offset int, limit int) (result []*model.Alias, count int64, err error)
...
func (a aliasDo) Create(values ...*model.Alias) error {
	if len(values) == 0 {
		return nil
	}
...
func (a aliasDo) CreateInBatches(values []*model.Alias, batchSize int) error {
	return a.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (a aliasDo) Save(values ...*model.Alias) error {
	if len(values) == 0 {
		return nil
	}
...
func (a aliasDo) First() (*model.Alias, error) {
	if result, err := a.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model.Alias), nil
	}
}

func (a aliasDo) Take() (*model.Alias, error) {
...
func (a aliasDo) Last() (*model.Alias, error) {
...
func (a aliasDo) Find() ([]*model.Alias, error) {
	result, err := a.DO.Find()
	return result.([]*model.Alias), err
}

func (a aliasDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.Alias, err error) {
	buf := make([]*model.Alias, 0, batchSize)
...
func (a aliasDo) FindInBatches(result *[]*model.Alias, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (a aliasDo) FirstOrInit() (*model.Alias, error) {
...
func (a aliasDo) FirstOrCreate() (*model.Alias, error) {
...
func (a aliasDo) FindByPage(offset int, limit int) (result []*model.Alias, count int64, err error) {
...
func (a aliasDo) Delete(models ...*model.Alias) (result gen.ResultInfo, err error) {
